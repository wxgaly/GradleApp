 ...
 * question.medium.
 *
 * @author Created by WXG on 2020-06-04 13:48
 * @version V1.0
 *
...
public class FindCorrespondingNodeofaBinaryTreeinaCloneofThatTree {
    ...
    /**
     * 前序遍历
     * 题解： https://leetcode-cn.com/problems/find-a-corresponding-node-of-a-binary-tree-in-a-clone-of-that-tree/solution/tong-shi-bian-li-liang-ke-shu-jin-xing-jie-dian-pi/
     *
     * @param original
     * @param cloned
     * @param target
