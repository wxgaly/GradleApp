 ...
 *  question.medium.
 *
 * @author Created by WXG on 2020-08-24 13:48
 * @version V1.0
 *
...
fun main() {
    ...
    println(getKth(1, 1, 1))
    println(getKth(7, 11, 4))
    println(getKth(10, 20, 5))
...
fun getKth(lo: Int, hi: Int, k: Int): Int {
    ...
    val list = map.toList().sortedWith(Comparator { o1, o2 ->
        when {
