 ...
 *  question.medium.
 *
 * @author Created by WXG on 2020-07-13 15:29
 * @version V1.0
 *
    ...
    answer[i] = 0 if seq[i] is part of A, else answer[i] = 1.  Note that even though multiple answers may exist, you may return any of them.
